...
const LeftInfo = () => {
  ...
  const references = [titleRef,subtitleRef,itextRef,itextRef2,itextRef3,menuRef]
    ...
    <div className="left-container section-container">
      <div className="top-path">
        <div className="intro">
          <div className="uncutable" >
              <div className="title" ref={titleRef}> Migu.<div className="yellow">es</div>() </div> 
          </div>
          <div className="uncutable" >
             <div className="subtitle yellow" ref={subtitleRef}>Miguel Rodriguez - Full Stack developer</div> 
          </div>
          <div className="uncutable">
            <div className="i-text" ref={itextRef}>I create awesome <strong className="white">apps</strong> and </div>
          </div>  
          <div className="uncutable">
            <div className="i-text" ref={itextRef2}>unique <strong className="white">web experiences</strong>, let's </div>
          </div>
          <div className="uncutable">
            <div className="i-text" ref={itextRef3}><strong className="white">build</strong> something <strong className="white">together</strong></div>
          </div>
        </div>
        <div className="uncutable">
      ...
      <div className="footer-path" ref={footerRef}>
        ...
        <div className="social">
            <a className="s-network" href="https://github.com/MiguelRodriguezR" target="_blank">
            ...
            <a className="s-network" href="https://twitter.com/MiguelRodriR" target="_blank">
